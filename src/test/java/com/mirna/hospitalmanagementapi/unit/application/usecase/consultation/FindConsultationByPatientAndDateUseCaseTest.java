...
@ActiveProfiles("test")
public class FindConsultationByPatientAndDateUseCaseTest {
	...
	/**
	 * Should execute findConsultationByPatientAndDate method 
	 * 
	 */
	@Test
	@DisplayName("Should execute findConsultationByPatientAndDate method")
	public void testfindConsultationByPatientAndDate() throws Exception {
		Consultation consultation = this.findConsultationByPatientAndDate.execute(testPatientId, testConsultationDate);
